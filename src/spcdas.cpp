...
byte op = spc.mem[spc.pc];
  ...
  case 0x0d: disas(1, "push  p");                 break;
  case 0x0e: disas(3, "tset $*w,a", 1);           break;
  ...
  case 0x2a: disas(3, "or1   c,!($*o).*e", 1);    break;
  ...
  case 0x4e: disas(3, "tclr  $*w,a", 1);          break;
  ...
  case 0x6a: disas(3, "and1  c,!($*o).*e", 1);       break;
